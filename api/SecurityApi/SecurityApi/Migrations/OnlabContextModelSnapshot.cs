...
namespace SecurityApi.Migrations
{
    ...
    partial class OnlabContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("SecurityApi.Model.Dashboard", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Dashboar__3214EC27EB0A7CCD");
            ...
            modelBuilder.Entity("SecurityApi.Model.Job", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Jobs__3214EC27DAAB7DC5");

                    b.HasIndex("PeopleId");

                    b.HasIndex(new[] { "Title" }, "UQ__Jobs__2CB664DC052710DB")
                        .IsUnique()
            ...
            modelBuilder.Entity("SecurityApi.Model.PeopleJob", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__PeopleJo__3214EC2702AC13E0");
            ...
            modelBuilder.Entity("SecurityApi.Model.Person", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__People__3214EC272E84FF20");

                    b.HasIndex(new[] { "Username" }, "UQ__People__536C85E4477C00D6")
                        .IsUnique()
            ...
            modelBuilder.Entity("SecurityApi.Model.Position", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Position__3214EC27A8B08031");
            ...
            modelBuilder.Entity("SecurityApi.Model.Role", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Roles__3214EC2775EA9E73");

                    b.HasIndex(new[] { "Title" }, "UQ__Roles__2CB664DC94E0B49A")
                        .IsUnique()
                        .HasFilter("[Title] IS NOT NULL");
            ...
            modelBuilder.Entity("SecurityApi.Model.Shift", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Shifts__3214EC27EF801669");
            ...
            modelBuilder.Entity("SecurityApi.Model.State", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__States__3214EC27FCF937CA");

                    b.HasIndex(new[] { "Title" }, "UQ__States__2CB664DCE6DF2B2F")
                        .IsUnique()
                        .HasFilter("[Title] IS NOT NULL");
            ...
            modelBuilder.Entity("SecurityApi.Model.Wage", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Wages__3214EC27E1C7D797");

                    b.HasIndex(new[] { "Name" }, "UQ__Wages__737584F6CC418525")
                        .IsUnique()
